...
- [x] Implement search into button in navigation bar.
- [x] Autolayout for image display on different devices.
- [x] Additional Filtering using words in overview.
- [x] SwiftyJSON pod for more simple JSON parsing.
...
<img src='Flicker.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
<img src='Flicker2.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
